...
|------|------|----------|----------|----------|------|
| 2037.06~ | 63세 | 580만원 | 420만원 | — | **1,000만원** |
| 2039.06~ | 65세 | 580만원 | 420만원 | 132만원 | **1,132만원** |
...
| | 개인 | 퇴직 | 국민 | 합계 |
|---|---|---|---|---|
| 카드 | 5,803,386 | 4,200,000 | 1,320,920 | 11,324,306 |
| 표 최신행 | 5,803,386 | 4,200,000 | 1,320,920 | 11,324,306 |

**분배율도 그 달 시점 값으로 되살린다.** 요약 카드가 "최근 12회 평균"을 쓰므로,
과거 달도 `ref_date <= 그 달 말일` 인 최근 12회 평균(`monthlyRateAt()`)을 쓴다.

퇴직연금은 이 값 하나만 변한다 — 정년 퇴직금(17,683만)도 거치 개월(36)도 그 달 시점과 무관하다.
...
```
원금  8,815만 / 17,683만 = 0.50배   ← 그 달 퇴직이 불리
...
| 연금 | 범위 | 월 수령액 변화 |
|------|------|----------------|
| **합계** | 2026.05 → 2026.08 | 1,229만 → 1,132만 **−7.9%** |
| 개인연금 | 2026.05 → 2026.08 | 679만 → 580만 **−14.5%** (2026-07 주가 26,320→20,300) |
| 퇴직연금 | 최근 12개월 | 453만 → 420만 **−7.3%** (분배율 17.99% → 17.13%) |
...
2026-05  6,788,237  4,190,000  1,311,130   12,289,367  -           -
2026-06  6,910,083  4,200,000  1,314,393*  12,424,476  +135,109    +1.1%
2026-07  5,827,969  4,240,000  1,317,657*  11,385,626  -1,038,850  -8.4%
2026-08  5,803,386  4,200,000  1,320,920   11,324,306  -61,320     -0.5%
```
