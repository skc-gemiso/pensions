...
| 연금 | 범위 | 월 수령액 변화 |
|------|------|----------------|
| **합계** | 2026.05 → 2026.08 | 1,235만 → 1,143만 **−7.4%** |
...
2026-05  6,830,799  4,210,000  1,311,130   12,351,929  -           -
2026-06  6,931,657  4,240,000  1,314,393*  12,486,050  +134,121    +1.1%
2026-07  5,748,287  4,270,000  1,317,657*  11,335,944  -1,150,106  -9.2%
2026-08  5,803,386  4,310,000  1,320,920   11,434,306  +98,362     +0.9%
```
...
- 연금마다 컬럼이 다르므로 **탭으로 나눈다** (`tab` 상태 + `active`). 기본 탭은 **합계**
  ...
  ```
- `baseLabel` 이 `null`(퇴직·합계)이면 그 컬럼 자체를 그리지 않고,
