...
| | 개인 | 퇴직 | 국민 | 합계 |
|---|---|---|---|---|
| 카드 | 5,803,386 | 3,970,000 | 1,320,920 | 11,094,306 |
| 표 최신행 | 5,803,386 | 3,970,000 | 1,320,920 | 11,094,306 |

**분배율도 그 달 시점 값으로 되살린다.** 요약 카드가 "최근 12회 평균"을 쓰므로,
과거 달도 `ref_date <= 그 달 말일` 인 최근 12회 평균(`monthlyRateAt()`)을 쓴다.

퇴직연금은 이 값 하나만 변한다 — 원금은 회사 사전 계산값(16,700만)이고 거치 개월(36)도 고정이다.
...
| 연금 | 범위 | 월 수령액 변화 |
|------|------|----------------|
| **합계** | 2026.05 → 2026.08 | 1,206만 → 1,109만 **−8.0%** |
| 개인연금 | 2026.05 → 2026.08 | 679만 → 580만 **−14.5%** (2026-07 주가 26,320→20,300) |
| 퇴직연금 | 최근 12개월 | 428만 → 397만 **−7.2%** (분배율 17.99% → 17.13%) |
...
2026-05  6,788,237  3,960,000  1,311,130   12,059,367  -           -
2026-06  6,910,083  3,960,000  1,314,393*  12,184,476  +125,109    +1.0%
2026-07  5,827,969  4,000,000  1,317,657*  11,145,626  -1,038,850  -8.5%
2026-08  5,803,386  3,970,000  1,320,920   11,094,306  -51,320     -0.5%
```
